...
//
// BACKEND INTEGRATION:
// - Line 55: handleSubmit() - POST /api/auth/login
// - Line 75: handleGoogleLogin() - POST /api/auth/google (when implemented)
//
// FORM VALIDATION:
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // This will call POST /api/auth/login
  ...
  // ==========================================================================
  // FUNCTION: HANDLE GOOGLE LOGIN (PLACEHOLDER)
  // ==========================================================================
  /**
   ...
   * 5. Use @react-oauth/google package
   * 6. Call backend with Google token
   * 
   * BACKEND INTEGRATION:
   * - Endpoint: POST /api/auth/google
   * - Send: { google_token: string }
   * - Receive: { access_token: string, user: object }
   */
  const handleGoogleLogin = () => {
    alert('Google OAuth integration pending. Will be implemented when backend is ready.')
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 xs:mb-8">
          ...
          <p className="text-sm xs:text-base text-tecnot-light dark:text-gray-400">
            AI Clinical Scribe for Doctors
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 xs:p-8 sm:p-10 transition-colors">
          ...
          {/* Card Header */}
          <h2 className="text-xl xs:text-2xl font-bold text-gray-900 dark:text-white mb-2">
            Welcome Back
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 xs:space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input 
                  type="checkbox" 
                  className="w-4 h-4 text-tecnot-primary dark:text-tecnot-light rounded 
              ...
              <Link 
                to="#" 
                className="text-tecnot-primary dark:text-tecnot-light hover:underline font-medium"
              >
                Forgot password?
              </Link>
            </div>
